...
import DemoSpeaker from "./Components/TTS/DEMOindex";
      ...
      <TurnoProvider>
        <BrowserRouter basename="/tk">
          <Routes>
            ...
            <Route path="/" element={<Home />} />
            {/* <Route path="/vc" element={<DemoSpeaker text={'hola mundo'} />} /> */}
            ...
            {/* <Route path="/pantalla" element={<DisplayScreen />} />  //pantalla original */}
